...
- Validate privacy-related changes (data stays local by default)

---

## Agent-Specific Instructions
- Default to Chinese (简体中文) in user-facing replies
- Follow Cursor rules in `.cursor/rules/*.mdc`:
  - `arch.mdc` → `docs/ai-work/code-style.md`
  - `content-ui.mdc` → `docs/ai-work/content-ui.md`
  - `doc-sync.mdc` → `docs/ai-work/doc-sync.md`
  - `token-saving.mdc` → `docs/ai-work/token-saving.md`

### Token Saving Guidelines
- Don't explain obvious code or language basics
- Don't repeat unchanged code
- Don't summarize file content unless required
